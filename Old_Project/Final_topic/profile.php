...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="site-heading text-center text-white d-none d-lg-block">
      <span class="site-heading-upper text-primary mb-3">Introduction</span>
      <span class="site-heading-lower">簡介</span>
    </h1>
            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                  ...
                  for ($i = 1 ; $i <= $rowcount ; $i++) {
                      $sql  = "SELECT `title`,`title_eng`,`content` FROM `teacher_profile_info` WHERE `id` = '$i'";
                      $result = mysqli_query($link, $sql);
                      $row = mysqli_fetch_row($result);
                      ?>
                      <h2 class="section-heading mb-4">
                          <span class="section-heading-upper"><?php echo $row[1];?></span>
                          <span class="section-heading-lower"><?php echo $row[0];?></span>
                      </h2>
                      <p><?php echo $row[2];?></p>
                      <p><-----------------------------------------------------------------------------------></p>
                  <?php
